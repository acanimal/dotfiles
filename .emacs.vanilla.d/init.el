...
(custom-set-variables
 ...
 '(package-selected-packages
   '(yaml-mode restclient magit multiple-cursors dap-mode lsp-treemacs lsp-ivy lsp-ui lsp-mode apheleia flycheck typescript-mode tree-sitter-langs tree-sitter treemacs-icons-dired treemacs-all-the-icons all-the-icons treemacs-projectile treemacs rg projectile company ivy-rich ivy-prescient counsel dimmer helpful which-key solaire-mode doom-modeline doom-themes dashboard use-package)))
(custom-set-faces
